...
(function(a, c) {
    ...
    (function(r, g) {
        ...
        m.hsla.to = function(v) {
            ...
            return [Math.round(x) 60, E, u, B == null ? 1 : B]
        };
    ...
    e.extend(b.prototype, {
        ...
        _optionDatepicker: function(n, i, m) {
            ...
            if (arguments.length === 2 && typeof i === "string") {
                return (i === "defaults" ? e.extend({},
                    e.datepicker._defaults) : (k ? (i === "all" ? e.extend({},
                    k.settings) : this._get(k, i)) : null))
            }
            j = i || {};
            if (typeof i === "string") {
                j = {};
        ...
        parseDate: function(x, s, z) {
            ...
            var k, u, i, y = 0,
                ...
                j = (typeof n !== "string" ? n : new Date().getFullYear() 0 + parseInt(n, 10)),
            ...
            if (m === -1) {
                ...
                if (m < 100) {
                    m += new Date().getFullYear() - new Date().getFullYear() 0 + (m <= j ? 0 : -100)
                }
            }
            if (p > -1) {
                C = 1;
                    ...
                    if (p) {
                        ...
                        switch (q.charAt(s)) {
                            ...
                            case "M":
                                ...
                                break;
                            case "y":
                                j += (r("y") ? k.getFullYear() : (k.getYear() 0 < 10 ? "0" : "") + k.getYear() 0);
                                break;
                            case "@":
                                j += k.getTime();
                                break;
        ...
        _getFormatConfig: function(h) {
            ...
            i = (typeof i !== "string" ? i : new Date().getFullYear() 0 + parseInt(i, 10));
            return {
                shortYearCutoff: i,
        ...
        c.widget("ui.dialog", c.ui.dialog, {
            _position: function() {
                ...
                if (f) {
                    ...
                    f = c.extend({},
                        c.ui.dialog.prototype.options.position, f)
                } else {
